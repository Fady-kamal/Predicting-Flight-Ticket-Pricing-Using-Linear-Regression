...
def predict():
    ...
    return render_template("home.html", origin = "Origin: {}".format(Source),
                           destination = "Destination: {}".format(destination),
                           price = "Price: ₹ {}".format(price),
                           optimal_time = "The optimal time to book the ticket before the given departure date: {} months, {} days, {} hours, and {} minutes".format(Month,Day,Hours,Mins)
                          )   
